...
class M_siswa_nilai extends CI_Model {
    ...
    public function get_nilai($siswa_nisn){
        $this->db->select('tb_mapel.id_mapel, tb_mapel.nama_mapel, tb_mapel.kkm, 
                            tb_nilai.nilai, tb_nilai.nisn, tb_nilai.tugas, 
                            tb_nilai.uts, tb_nilai.uas,
                            tb_nilai.predikat_nilai, tb_nilai.predikat_tugas,
                            tb_nilai.predikat_uts,
                            tb_nilai.predikat_uas');
        $this->db->from('tb_nilai');
